...
export const plantoes: Plantao[] = [
    { id: "1", date: new Date().toLocaleDateString("pt-br"), start: "23:00", duration: 6, locale: "Sta. Casa de Getulina" , sector: "Sala de emergências", value: "1500,00", responsable: "Fulano", onduty: "Medico" },
    ...
    { id: "4", date: "10/04/2026", start: "07:00", duration: 6, locale: "Unimar", sector: "Pronto socorro", value: "750,00", responsable: "Fulano", onduty: "Medico" },
    ...
    { id: "7", date: "09/04/2026", start: "07:00", duration: 6, locale: "Unesp" , sector: "Sala de emergências", value: "1500,00", responsable: "Fulano2", onduty: "Medico" },
    ...
    { id: "10", date: "08/04/2026", start: "07:00", duration: 6, locale: "Unesp" , sector: "Pronto socorro", value: "1500,00", responsable: "Fulano2", onduty: "Medico" },
    { id: "12", date: "09/04/2026", start: "07:00", duration: 6, locale: "Unesp" , sector: "Pronto socorro", value: "1500,00", responsable: "Fulano2", onduty: "Medico" },
